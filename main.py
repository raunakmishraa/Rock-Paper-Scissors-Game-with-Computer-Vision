...
def resultWindow(yr_choice, dev_choice, result):
    ...
    paper_path = r"D:\Innovation\Python_Programs\AI\Rock_paper_scissor_game\venv\Include\paper.jpg"
    rock_path = r"D:\Innovation\Python_Programs\AI\Rock_paper_scissor_game\venv\Include\rock.jpg"
    scissor_path = r"D:\Innovation\Python_Programs\AI\Rock_paper_scissor_game\venv\Include\scissor.jpg"
    ...
    final_result = Label(win, text=result, font=("Times", "20"), fg="tomato", bg="#fff")
    final_result.pack()
    final_result.place(x=325, y=350)
#Create Game Window
def startGame():
    ...
    while True:
        ...
        if lmList:
            ...
            if str(thumbFinger) == "0" and str(indexFinger) == "0" and str(midFinger) == "0" and str(ringFinger) == "0" and str(lastFinger) == "0":
...
win.iconbitmap('./Include/Brand-Logo-Icon.ico')
#App Name
